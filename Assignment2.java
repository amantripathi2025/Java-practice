...
//         Node temp = head;
//         while (temp != null) {
//          reversedLinkedList.addAtBeginning(temp.getData()); //  fixed case + semicolon
//          temp = temp.getNext();                             //  actually advances
//        }
        if (head == null)
            return;
        reverseList(head.getNext(), reversedLinkedList);  // recurse to the end first
